...
include '../../controladores/compras.controlador.php';
...
$compra = ControladorCompras::ctrMostrarComprasInfo($item, $valor);

$id          = $compra['id'];
$serie       = $compra['serie'];
$numero      = $compra['num_doc'];
$fecha       = $compra['fecha'];
$idproveedor = $compra['id_proveedor'];
$idformapago = $compra['id_forma_pago'];
$estado      = $compra['estado'];
$total       = $compra['total'];

$item       = "id";
$valor      = $idproveedor;
$resultado1 = ControladorProveedor::ctrMostrarProveedorInfo($item, $valor);
$proveedor  = $resultado1["nombre"];
$ruc        = $resultado1["ruc"];
$direccion1 = $resultado1["direccion_web"];
$tienda     = $resultado1["tienda"];
...
$pdf->SetXY(130, 15);
$pdf->Cell(90, 10, 'FACTURA ELECTRONICA');
...
$pdf->SetXY(15, 45);
$pdf->Cell(10, 10, 'RAZONSOCIAL: ');
$pdf->SetXY(45, 45);
$pdf->Cell(10, 10, substr($proveedor, 0, 38));
$pdf->SetXY(45, 50);
$pdf->Cell(60, 10, substr($proveedor, 38, 40));
...
$pdf->SetXY(45, 55);
$pdf->Cell(60, 10, substr($direccion2, 0, 42));

$pdf->SetXY(45, 60);
$pdf->Cell(60, 10, substr($direccion2, 42, 40));
...
$detalles = ControladorCompras::ctrMostrarDetallesComprasInfo($item, $valor);
