                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                          <div class="card-header">
                              ...
                              <div class="row">
                              <div class="col-md-2">
                                <a href="proveedor" class="btn btn-primary btn-lg" role="button" aria-disabled="true"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Proveedor</a>
                              </div>

                              <div class="col-md-9">
                                  <center><strong class="card-title">REALIZAR COMPRA</strong></center>
                              </div>
                            </div>
                             ...
                             <div class="col-md-8 col-xs-12">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <select class="form-control input-lg"  id="productoProveedor" name="productoProveedor">
...
$tipo = ControladorProveedor::ctrMostrarProveedor($item, $valor);

foreach ($tipo as $key => $value) {

    if ($value["estado"] == 1) {

        echo '<option value="' . $value["id"] . '">' . $value["tienda"] . ' ; ' . $value["nombre"] . '</option>';
...
?>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-8 col-xs-12">
                              <div class="input-group">
                                  ...
                                  <input type="number" class="form-control input-lg" id="productoDocumento"  name="nuevoColor" >
                        ...
                        <div class="col-md-10">
                          ...
                          <div class="col-md-10">
                            ...
                            ======================================-->
                                      <div class="card-body cuerpoCarritoCompra">
                                          <!-- item1 -->
                                  ...
                                  <div class="">
                                          <a class="btn btn-success btn-lg pull-left " href="comprobantes_compra">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <!-- ENTRADA PARA TABLA-->
              <table  class="table table-bordered table-striped dt-responsive tablaProductosMaquinas" id="tablaProductosMaquinas">
                                    <thead>
                                        <tr>
                                            <th>Agregar</th>
                                            <th>Imagen</th>
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
           ...
           <table  class="table table-bordered table-striped dt-responsive tablaProductosRepuestos" id="tablaProductosRepuestos">
                                    <thead>
                                        <tr>
                                            <th>Agregar</th>
                                            <th>Imagen</th>
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
           ...
           <table  class="table table-bordered table-striped dt-responsive tablaProductosOtros" id="tablaProductosOtros">
                                    <thead>
                                        <tr>
                                            <th>Agregar</th>
                                            <th>Imagen</th>
