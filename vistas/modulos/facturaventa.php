...
$compra = ControladorVentas::ctrMostrarVentasInfo($item, $valor);

$id          = $compra['id'];
$serie       = $compra['serie'];
$numero      = $compra['num_doc'];
$fecha       = $compra['fecha'];
$idcliente   = $compra['id_cliente'];
$idformapago = $compra['idforma_pago'];
...
$direccion2 = $resultado1["direccion"];
...
$pdf->SetXY(45, 45);
$pdf->Cell(10, 10, substr($cliente, 0, 38));
$pdf->SetXY(45, 50);
$pdf->Cell(60, 10, substr($cliente, 38, 40));
