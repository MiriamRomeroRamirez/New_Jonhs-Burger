...
$clientes      = ControladorCliente::ctrMostrarTotalClientes("id");
...
$ventasgrafico = ControladorVentas::ctrMostrarVentasGrafico();
...
foreach ($ventasgrafico as $key => $value) {

$total += $value["total"];

$porcentajePaypal = $total * 100 / $ventas["total"];
            ...
            <div class="animated fadeIn">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count"><?php echo number_format($totalProductos); ?></span></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count"><?php echo number_format($totalClientes); ?></span></div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">Tabla de Ventas </h4>
                            </div>
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="card-body">
                                ...
                                <div class="col-lg-4">
                                    <div class="card-body">
                                        <div class="progress-box progress-1">
                                            <h4 class="por-title">Clientes</h4>
                                        ...
                                        <div class="progress-box progress-2">
                                            <h4 class="por-title">Proveedores</h4>
                                        ...
                                        <div class="progress-box progress-2">
                                            <h4 class="por-title">Empleados</h4>
                                        ...
                                        <div class="progress-box progress-2">
                                            <h4 class="por-title">Administradores</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-xl-12">
                                    <div class="card bg-flat-color-3  ">
                                        <div class="card-body">
                                            <h4 class="card-title m-0  white-color ">Setiembre 2020</h4>
                                        </div>
                                         <div class="card-body">
